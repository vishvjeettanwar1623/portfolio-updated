...
function HeroGeometric({
    ...
    const fadeUpVariants = {
        ...
        visible: (i: number) => ({
            ...
            transition: {
                duration: 1,
                delay: animationDelay + 0.5 + i * 0.2,
    ...
    return (
        <div className="absolute inset-0 w-full h-full flex items-center justify-center overflow-hidden pointer-events-none">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 -translate-y-16">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-foreground/90 to-rose-500 dark:from-indigo-300 dark:via-white/90 dark:to-rose-300"
                                )}
                            >
                                {title2}
                            </span>
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-foreground/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            ...
                            Changing ideas into code and Codes into reality. <br/>
                            This is my journey from bits to GigaBytes
                        </p>
                    </motion.div>
                </div>
            </div>
